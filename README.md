...
of [Joel Grus](https://github.com/joelgrus/). His code can be found in [here](https://github.com/joelgrus/autograd/). The user experience (nn.Module etc.) of ToeffiPy is similar to [PyTorch](https://pytorch.org/). 
